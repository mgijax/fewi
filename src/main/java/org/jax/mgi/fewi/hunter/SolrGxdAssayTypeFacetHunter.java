...
@Repository
public class SolrGxdAssayTypeFacetHunter extends SolrGxdSummaryBaseHunter {
	 ...
	 */
	public SolrGxdAssayTypeFacetHunter() {
		...
		facetString = IndexConstants.GXD_ASSAY_TYPE_FACET;
