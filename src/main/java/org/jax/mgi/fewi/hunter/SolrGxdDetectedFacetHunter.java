...
@Repository
public class SolrGxdDetectedFacetHunter extends SolrGxdSummaryBaseHunter {
	 ...
	 */
	public SolrGxdDetectedFacetHunter() {
		...
		facetString = IndexConstants.GXD_DETECTED_FACET;
