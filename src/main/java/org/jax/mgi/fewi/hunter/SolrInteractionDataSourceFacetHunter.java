...
@Repository
public class SolrInteractionDataSourceFacetHunter extends SolrInteractionBaseHunter {
     ...
     */
    public SolrInteractionDataSourceFacetHunter() {        
        ...
        facetString = IndexConstants.SCORE_SOURCE;
