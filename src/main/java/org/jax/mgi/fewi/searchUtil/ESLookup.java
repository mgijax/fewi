 ...
 * </p>
 * <ul>
 * <li><b>mainIndex:</b> The primary index for the query (e.g.,
 * gxd_result_has_image)</li>
 * <li><b>lookupIndexes:</b> List of {@link ESLookupIndex} objects representing
 * lookup indices and their join fields.</li>
 * <li><b>extraStatements:</b> Additional query statements appended as
 * needed.</li>
 * </ul>
 * 
 * <p>
 ...
 * </p>
 * <ul>
 * <li>The first WHERE clause is typically generated by {@link SearchParams},
 * e.g., WHERE markerSymbol == "Wnt1".</li>
 * <li>The LIMIT clause is also generated by {@link SearchParams}.</li>
 * <li>Prerequisites for LOOKUP JOIN: The lookup index must have the appropriate
 * type configured.</li>
 * </ul>
 * 
 * @see ESQuery
...
public class ESLookup extends ESQuery {
	...
	public ESLookup(String indexName) {
		super(indexName);
	}
	
	/**
	 * Converts this object into a query string, including any configured LOOKUP
	 * JOIN statements.
	 *
	...
	public String toQuery(List<String> whereCauses, int size, boolean isGetTotalCount) {
		this.lookupJoinStatements = new ArrayList<>();
		if (this.lookupIndexes != null && !this.lookupIndexes.isEmpty()) {

			for (ESLookupIndex lookupIndex : this.lookupIndexes) {
				if ( lookupIndex.isJoinFieldMultiValues()) {
					this.lookupJoinStatements.add("MV_EXPAND " + lookupIndex.getJoinFieldName());
				}
				this.lookupJoinStatements
						.add("LOOKUP JOIN " + lookupIndex.getIndexName() + " ON " + lookupIndex.getJoinFieldName());
			}
		}

		return super.toQuery(whereCauses, size, isGetTotalCount);
	}
