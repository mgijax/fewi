...
function main() {
    ...
    var myColumnDefs = [
        ...
        {key:"nomenclature",
			...
			width:245},
	{key:"detectedSystems",
			label:"Recombinase Activity<br/>Detected in Anatomical Structure",
			sortable:true,
//			sortOptions: { defaultDir: YAHOO.widget.DataTable.CLASS_DESC },
			width:200},
	{key:"notDetectedSystems",
			label:"Recombinase Activity<br/>Not Detected in Anatomical Structure",
			sortable:true,
//			sortOptions: { defaultDir: YAHOO.widget.DataTable.CLASS_DESC },
			width:200},
	{key:"affectedCellTypes",
			label:"Recombinase Activity<br/>Detected in Cell Types",
			sortable:false,
//			sortOptions: { defaultDir: YAHOO.widget.DataTable.CLASS_DESC },
			width:120},
        {key:"inducibleNote",
