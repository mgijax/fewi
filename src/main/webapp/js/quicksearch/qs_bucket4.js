...
function b4Show(data) {
	...
	if (data.rows.length > 0) {
		...
		tbl = tbl + '<TR><TH>Score' + qsScoreHelp() + '</TH><TH class="termCol">Name</TH><TH class="imsrCol">Find Mice (IMSR)</TH><TH class="dataCol">References</TH><TH class="bestMatchCol">Best Match</TH></TR>';
