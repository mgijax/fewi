...
<div style="padding-bottom: 8px">
<a href="${configBean.FEWI_URL}vocab/gxd/anatomy/${result.accID}" onClick="resetPanes('${result.accID}', true, '${result.structure}'); return false;">${result.highlightedStructure}</a>
