...
<table class="summaryHeader">
	<tr >
	  <td class="summaryHeaderCat1Gxd" style="vertical-align:bottom">
	       <div style="padding-top:3px; font-weight: bold">Cell Type</div>
	       <div style="padding-top:2px; font-weight: bold">ID</span>
	  </td>
	  <td class="summaryHeaderData1" style="vertical-align:bottom">
	    <div style="">
		<a style="font-size:large;  font-weight: bold;" href="${configBean.FEWI_URL}vocab/cell_ontology/${cellTypeTerm.primaryID}">${e:forHtml(cellTypeTerm.term)}</a>
	    <div style="padding-top:2px;">${cellTypeTerm.primaryID}</div>
	  </td>
	</tr>
</table>
...
<script type="text/javascript">
    ...
    var querystring = "annotationId=${e:forJavaScript(cellTypeTerm.primaryID)}&tab=${e:forHtml(tab)}";
