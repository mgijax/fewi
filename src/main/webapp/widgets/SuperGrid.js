...
function SGData(config)
{
    ...
    this.addCell = function(cell,acceptableRids)
    {
        ...
        cell.ci = _self.addColumn({cid:cell.cid});
...
function SuperGrid(config)
{
    ...
    */
    ...
    this.renderLegend = function()
    {
		...
		legendGroup.append("rect")
	    	...
	    	.attr("width",120)
	    	.style("cursor","pointer")
	    	.attr("class","matrixLegendBoxUnderlay");
    ...
    this.renderFilterButton = function()
    {
    	...
    	_self.filterButtonGroup.append("rect")
			.attr("x",1)
			.attr("y",1)
			.attr("width",_self.cellSize-3)
			.attr("height",_self.cellSize-3)
			.style("fill","#fafafa")
			.style("stroke","#fafafa");
    	...
    	if(_self.filterButtonIconUrl)
    	{
    		_self.filterButtonGroup.append("image")
    			...
    			.attr("width",_self.cellSize * (3/4))
    			.attr("height",_self.cellSize * (3/4))
    			.attr("xlink:href",_self.filterButtonIconUrl)
	    		.append("svg:title")
	    			.text("Click to submit rows to filter.");
    	}
    	else
    	{
    ...
    */
    ...
    {
    	//var maxRowLength = _self.rowGroupInner[0][0].getBBox().width;
