 ...
 */
public class GxdStageMatrixPopupTest {
	...
	private GxdStageMatrixPopup popup;
	
	@Before
	public void setup() {
		this.popup = new GxdStageMatrixPopup(PARENT_ID,"parent");
	}
	
	@Test
	public void testNoResults() {
		popup.setAssayResultList(results());
		Assert.assertEquals(Int(0),popup.getCountPosGenes());
		Assert.assertEquals(Int(0),popup.getCountAmbGenes());
		Assert.assertEquals(Int(0),popup.getCountNegGenes());
	...
	public void testOnePositive() {
		...
		popup.setAssayResultList(results);
		Assert.assertEquals(Int(1),popup.getCountPosGenes());
		Assert.assertEquals(Int(0),popup.getCountAmbGenes());
		Assert.assertEquals(Int(0),popup.getCountNegGenes());
	...
	public void testOneAmbiguousParent() {
		...
		popup.setAssayResultList(results);
		Assert.assertEquals(Int(0),popup.getCountPosGenes());
		Assert.assertEquals(Int(1),popup.getCountAmbGenes());
		Assert.assertEquals(Int(0),popup.getCountNegGenes());
		Assert.assertEquals(Int(0),popup.getCountPosResults());
	...
	public void testOneNegativeParent() {
		...
		Assert.assertEquals(Int(0),popup.getCountPosGenes());
		Assert.assertEquals(Int(0),popup.getCountAmbGenes());
		Assert.assertEquals(Int(1),popup.getCountNegGenes());
		Assert.assertEquals(Int(0),popup.getCountPosResults());
		Assert.assertEquals(Int(0),popup.getCountAmbResults());
	...
	public void testMultipleChildResults() {
		...
		popup.setAssayResultList(results);
		Assert.assertEquals(Int(2),popup.getCountPosGenes());
		Assert.assertEquals(Int(0),popup.getCountAmbGenes());
		Assert.assertEquals(Int(0),popup.getCountNegGenes());
	...
	public void testMultipleParentResults() {
		...
		popup.setAssayResultList(results);
		Assert.assertEquals(Int(2),popup.getCountPosGenes());
		Assert.assertEquals(Int(2),popup.getCountAmbGenes());
		Assert.assertEquals(Int(2),popup.getCountNegGenes());
		Assert.assertEquals(Int(2),popup.getCountPosResults());
