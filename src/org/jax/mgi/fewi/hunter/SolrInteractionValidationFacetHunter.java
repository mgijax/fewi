...
@Repository
public class SolrInteractionValidationFacetHunter extends SolrInteractionBaseHunter {
     ...
     */
    public SolrInteractionValidationFacetHunter() {        
        ...
        facetString = IndexConstants.VALIDATION;
