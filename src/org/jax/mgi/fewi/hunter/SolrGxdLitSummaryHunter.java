...
public class SolrGxdLitSummaryHunter extends SolrHunter<GxdLitIndexRecord> {
	...
	public SolrGxdLitSummaryHunter() {
		 ...
		 * implementation.
		 */
		propertyMap.put(SearchConstants.GXD_LIT_MRK_NOMEN,
				new SolrPropertyMapper(IndexConstants.GXD_MRK_NOMEN));
		propertyMap.put(SearchConstants.MRK_ID, new SolrPropertyMapper(
				IndexConstants.MRK_ID));
		propertyMap.put(SearchConstants.REF_YEAR, new SolrPropertyMapper(
				IndexConstants.REF_YEAR));
		propertyMap.put(SearchConstants.REF_JOURNAL, new SolrPropertyMapper(
				IndexConstants.REF_JOURNAL));
		propertyMap.put(SearchConstants.REF_AUTHOR_ANY, new SolrPropertyMapper(
		...
		propertyMap.put(IndexConstants.GXD_LIT_SINGLE_KEY,
				new SolrPropertyMapper(IndexConstants.GXD_LIT_SINGLE_KEY));
		propertyMap.put(SearchConstants.GXD_LIT_AGE, new SolrPropertyMapper(
				IndexConstants.GXD_LIT_AGE));
		propertyMap.put(SearchConstants.GXD_LIT_ASSAY_TYPE,
				new SolrPropertyMapper(IndexConstants.GXD_LIT_ASSAY_TYPE));
		propertyMap.put(IndexConstants.GXD_LIT_AGE_ASSAY_TYPE_PAIR,
				new SolrPropertyMapper(
						IndexConstants.GXD_LIT_AGE_ASSAY_TYPE_PAIR));

		propertyMap.put(IndexConstants.MRK_TERM_ID, new SolrPropertyMapper(
		...
		propertyMap.put(SearchConstants.REF_TEXT_TITLE_ABSTRACT,
				new SolrReferenceTextSearchPropertyMapper(titleAbstractList,
						"OR"));

		propertyMap.put(SearchConstants.MRK_KEY, new SolrPropertyMapper(
				IndexConstants.MRK_KEY));
		propertyMap.put(SearchConstants.REF_KEY, new SolrPropertyMapper(
				IndexConstants.REF_KEY));
