...
@Repository
public class SolrInteractionTermFacetHunter extends SolrInteractionBaseHunter {
     ...
     */
    public SolrInteractionTermFacetHunter() {        
        ...
        facetString = IndexConstants.RELATIONSHIP_TERM;
