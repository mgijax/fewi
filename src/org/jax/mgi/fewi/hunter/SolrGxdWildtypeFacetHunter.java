...
@Repository
public class SolrGxdWildtypeFacetHunter extends SolrGxdSummaryBaseHunter {
	 ...
	 */
	public SolrGxdWildtypeFacetHunter() {
		...
		facetString = IndexConstants.GXD_WILDTYPE_FACET;
