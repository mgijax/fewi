...
public class SolrGxdDifferentialHunter extends SolrHunter<String> {
    ...
    public SolrGxdDifferentialHunter() {        
        ...
        propertyMap.put(SearchConstants.MRK_KEY, new SolrPropertyMapper(GxdResultFields.MARKER_KEY));
        
        // search positive structures and their children (I.e. children whose "ancestor" is the search term)
        propertyMap.put(SearchConstants.POS_STRUCTURE, new SolrPropertyMapper(GxdResultFields.DIFF_POS_ANCESTORS));
