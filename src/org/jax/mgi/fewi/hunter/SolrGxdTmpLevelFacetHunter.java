...
@Repository
public class SolrGxdTmpLevelFacetHunter extends SolrGxdSummaryBaseHunter {
	 ...
	 */
	public SolrGxdTmpLevelFacetHunter() {
		...
		facetString = IndexConstants.GXD_TMPLEVEL_FACET;
