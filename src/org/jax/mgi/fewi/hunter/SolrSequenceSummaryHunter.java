...
import org.jax.mgi.fewi.queryMapper.PropertyMapper;
...
public class SolrSequenceSummaryHunter extends SolrHunter {
    ...
    public SolrSequenceSummaryHunter() {        
        ...
        propertyMap.put(SearchConstants.SEQUENCE_ID, new SolrPropertyMapper(IndexConstants.SEQUENCE_ID));
        propertyMap.put(SearchConstants.MARKER_KEY, new SolrPropertyMapper(IndexConstants.MARKER_KEY));
        propertyMap.put(SearchConstants.REFERENCE_KEY, new SolrPropertyMapper(IndexConstants.REFERENCE_KEY));
        propertyMap.put(SearchConstants.SEQUENCE_KEY, new SolrPropertyMapper(IndexConstants.SEQUENCE_KEY));
