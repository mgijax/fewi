...
@Repository
public class SolrGxdMarkerTypeFacetHunter extends SolrGxdSummaryBaseHunter {
	 ...
	 */
	public SolrGxdMarkerTypeFacetHunter() {
		...
		facetString = IndexConstants.GXD_MARKER_TYPE_FACET;
