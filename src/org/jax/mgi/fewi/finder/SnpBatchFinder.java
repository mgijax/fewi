...
public class SnpBatchFinder 
{
	...
	public SnpBatchFinder(SnpFinder finder, SearchParams searchParams, Integer batchSize)
	{
		this.finder=finder;
		this.searchParams=searchParams;
	...
	public SearchResults<ConsensusSNPSummaryRow> getNextResults()
	{
		...
		SearchResults<ConsensusSNPSummaryRow> results = finder.getSummarySnps(searchParams, matchedMarkerIds, null);
