...
import org.jax.mgi.fewi.hunter.SolrDiseasePortalHunterOLD;
...
public class DiseasePortalFinderOLD
{
	...
	private SearchResults<SolrString> huntHighlightedColumns(SearchParams params) {
		...
		params.getFilter().replaceProperty(DiseasePortalFields.TERM, DiseasePortalFields.TERM_SEARCH_DISEASE_TEXT);
	 ...
	 */
	public SearchResults<SolrString> getFeatureTypeFacet(SearchParams params) {
		SearchResults<SolrHdpEntity> results = new SearchResults<SolrHdpEntity>();
