...
public class HdpMarkerSummaryRow {
    ...
    public String getSymbol(){
    	...
    	String displayText = "<span class=\"jquiTT\" title=\"<b>Name: " + solrDiseasePortalMarker.getName() + " <br/>Feature Type: " + solrDiseasePortalMarker.getType() + "</b>\" ><a href=\"" + url + "/\">" + symbol + "</a></span>";
    	if("human".equalsIgnoreCase(solrDiseasePortalMarker.getOrganism()))
    	{
	    	...
	    	displayText = "<span class=\"jquiTT\" title=\"<b>Name: " + solrDiseasePortalMarker.getName() + "</b>\" ><a href=\"" + url + "/\">" + symbol + "</a></span>";
    	}
