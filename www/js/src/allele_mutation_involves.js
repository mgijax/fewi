function main() {
    ...
    var myColumnDefs = [
        {key:"mutation", 
            ...
            sortable:false},
        {key:"effects", 
            label:"Effects on Gene/Genome<br/>Feature",
            width:240, 
            sortable:false},
        {key:"featureType", 
            label:"Gene/Genome<br/>Feature Type",
            width:150, 
            sortable:false},
        {key:"location", 
            label:"Gene/Genome Feature<br/>Location",
            width:225, 
            sortable:false},
        {key:"reference", 
            label:"Reference",
    ...
    // DataSource instance
    var myDataSource = new YAHOO.util.DataSource(fewiurl + "allele/mutationInvolvesJson?" + querystring);
