...
#probeSummaryTable { width: 100%; }
#probeSummaryTable tr:nth-child(odd) { background-color: #dddddd; }
#probeSummaryTable th { border: 1px solid gray; padding: 4px; background-color: #d0e0f0; font-weight: bold; }
#probeSummaryTable td { border: 1px solid gray; padding: 4px; }
...
<!-- header bar -->
<div id="titleBarWrapper" userdoc="EXPRESSION_probe_summary_help.shtml" style="min-width: 1000px">
	<div id="pageHeaderWrapper" style='display:inline-block; margin-top: 5px;'>
	<span class="titleBarMainTitle">Molecular Probes and Clones Summary</span>
	</div>
</div>
...
<br clear="all" />
<%@ include file="/WEB-INF/jsp/probe/probe_summary_results.jsp" %>

<script type="text/javascript" src="${configBean.FEWI_URL}assets/js/probe/probe_summary.js"></script>
