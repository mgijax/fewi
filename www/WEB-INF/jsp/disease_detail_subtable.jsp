	  ...
	  <c:forEach var="diseaseRow" items="${diseaseGroup.diseaseRows}" varStatus="status">
	    ...
	    <td class="${borders} ${stripe} leftAlign"><c:if test="${not empty diseaseRow.homologyCluster}">
	      <a href="${configBean.FEWI_URL}homology/${diseaseRow.homologyCluster.primaryID}">${diseaseRow.homologyCluster.mouseMarkerCount}:${diseaseRow.homologyCluster.humanMarkerCount}</a> Homology
		</c:if>
	    </td>
	    </tr>
