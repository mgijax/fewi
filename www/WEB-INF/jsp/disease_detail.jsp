...
<title>Human Disease and Mouse Model Detail</title>
...
<table class="detailStructureTable">
  ...
  <c:if test="${not (empty disease.mouseHumanGroup and empty disease.mouseOnlyGroup and empty disease.humanOnlyGroup)}">
	...
	<td style="">&nbsp;</td>
	<td style="">&nbsp;</td>
	<td colspan="4" style="">${asterisk}<font size="-1"><b>Gene</b> is associated with the disease in this species</font></td>
	</tr>
