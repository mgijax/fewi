					...
					<table>
						...
						<tr>
							...
							<td></td><td style="padding-top: 4px;">
								<div style="width:13px; height:13px; background-color: #49648B; display: inline-block;">
									<div style="width:100%;height:100%; background: url('${configBean.FEWI_URL}assets/images/hdp/human_cell_sprite.gif') -6px -6px;"></div>
								</div>
