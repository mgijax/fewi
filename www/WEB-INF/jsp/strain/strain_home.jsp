...
<div class="col-md-4" style="">
				    ...
				    <div class="col-md-4" style="">
				      <a href="http://www.findmice.org/index.jsp"><img style="width:350px; height:170;" src="<!--#include file='include/fewi_url.html'-->assets/images/static/IMSRLink.png" alt="IMSR"></a>
				    </div>
				    </div>
<div class="col-md-4" style="">
