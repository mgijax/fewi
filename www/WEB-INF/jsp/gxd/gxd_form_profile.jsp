	...
	<tr class="stripe1">
		...
		<tbody id="profileStructureTableBody">
			<tr id="profileStructureRow1" >
				<td style="">
					<button type="button" onClick="removeStructureRow(1)" id="removeStructureRowButton" class="removeButton" title="Remove this structure.">X</button>
			...
			<tr id="profileStructureRow2" >
				<td style="">
					...
					<div id="profileStructureContainer2"></div>				
				</td>
			...
			<tr id="profileStructureRow3" >
				<td style="">
					...
					<div id="profileStructureContainer3"></div>				
				</td>
			...
			<tr id="profileStructureRow4" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer4"></div>				
				</td>
			...
			<tr id="profileStructureRow5" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer5"></div>				
				</td>
			...
			<tr id="profileStructureRow6" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer6"></div>				
				</td>
			...
			<tr id="profileStructureRow7" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer7"></div>				
				</td>
			...
			<tr id="profileStructureRow8" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer8"></div>				
				</td>
			...
			<tr id="profileStructureRow9" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer9"></div>				
				</td>
			...
			<tr id="profileStructureRow10" style="display:none;">
				<td style="">
					...
					<div id="profileStructureContainer10"></div>				
				</td>
