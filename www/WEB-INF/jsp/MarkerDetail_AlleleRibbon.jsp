				...
				<section class="summarySec1 extra open">
					...
					<c:if test="${not empty marker.slimgridCellsMP}">
						<div id="mpSlimgridWrapper" class="sgWrapper">
							<div class="label" style="width: 566px; text-align:center;">Phenotype Overview<img id="sgPhenoHelpImage" src="${configBean.FEWI_URL}assets/images/help_icon_16.png" style="margin-bottom: -3px; margin-left: 3px; cursor: pointer;"/></div><br />
