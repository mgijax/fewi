...
#genoLegendWrapper{max-width:950px;}
...
initGenoLegendTable = function() {
  ...
  <c:if test="${phenoTableGenoSize > 4}">
    var genoLegendDataTable = new YAHOO.widget.ScrollingDataTable("genoLegendDiv", genoLegendColDefs, genoLegendDataSrc, {height:"8em"});
  </c:if>
