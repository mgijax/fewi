		...
		<div class="row" >
			...
			<div class="detail <%=rightTdStyles.getNext() %>">
				<table>
					<tr>
						<td class="top">
							<span id="toggleSequenceRibbon" title="Show More" class="toggleImage hdCollapse" onclick="toggleRibbon('SequenceRibbon'); return false;"></span>
						</td>
						<td>
							<div id="closedSequenceRibbon" style="display:none;">
							</div>
