...
<tr>
  ...
  <td class="detailData2">
    ...
    <c:if test="${not empty genoCluster.marker}">
    	<br/>
		<span class='label'>Comparison Matrix</span> 
		<a href="${configBean.FEWI_URL}gxd/phenogrid/${genoCluster.marker.primaryID}?genoclusterKey=${genoCluster.genoClusterKey}" class="MP">Gene Expression + Phenotype</a>
    </c:if>
