...
<select <c:if test="${not empty id}">id="${id}"</c:if> <c:if test="${not empty name}">name="${name}"</c:if> <c:if test="${not empty multiple}">multiple="${multiple}"</c:if> <c:if test="${not empty size}">size="${size}"</c:if> <c:if test="${not empty class}">class="${class}"</c:if> >
